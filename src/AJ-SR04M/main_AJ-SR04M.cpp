...
void set_properties(Sensor1D *us) {
    ...
    std::string venderName = "Generic";
    std::string productName = "AJ-SR04M";
    DataType data_type = DataType::UINT16;

    // 측정 범위: 20cm ~ 450cm (단위는 미터)
    min_max_detect_range.min = 0.2f;
    min_max_detect_range.max = 4.5f;
    ...
    us->setProperties({}, min_max_detect_range, 0.0f, pose, data_type, 4.5f,
